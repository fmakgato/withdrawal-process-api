...
create table if not exists withdrawal (withdrawal_id bigint not null, investor_id bigint not null, product_id bigint not null, status varchar(255) not null, withdrawal_amount double not null, primary key (withdrawal_id));
